...
\indent We will now explore an example of integer factorization with Lenstra's algorithm. Let $N=5917$ and let $B=10$. Therefore,

\indent Discuss Elliptic Curve Diffie-Hellman.

\indent Insert numerical example.

\indent Discuss Elliptic Curve ElGamal?

\indent Discuss Elliptic Curve discrete logarithm.
